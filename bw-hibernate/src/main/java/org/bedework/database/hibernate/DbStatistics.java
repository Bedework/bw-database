...
public class DbStatistics {
  ...
  public static void dumpStats(Statistics dbStats) {
    ...
    new BwLogger().setLoggedClass(DbStatistics.class)
                  .debug(StatsEntry.toString(getStats(dbStats)));
  }
  ...
  public static Collection<StatsEntry> getStats(Statistics dbStats) {
    ...
    final String[] qs = dbStats.getQueries();
  ...
  private static void secondLevelStats(Collection<StatsEntry> c,
    ...
    c.add(new StatsEntry("Hit count",
                         dbStats.getSecondLevelCacheHitCount()));
    c.add(new StatsEntry("Miss count",
                         dbStats.getSecondLevelCacheMissCount()));
    c.add(new StatsEntry("Put count",
                         dbStats.getSecondLevelCachePutCount()));
